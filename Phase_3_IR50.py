...
# ============================================
# IR50 (ResNet50) Backbone Architecture
# ============================================
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, downsample=None):
        ...
        self.prelu = nn.PReLU(out_channels * self.expansion)
...
class IR50(nn.Module):
    """ResNet50-IR backbone for face recognition"""
    def __init__(self, num_layers=50, feature_dim=512):
        super(IR50, self).__init__()
        assert num_layers == 50, "Only ResNet50-IR is supported"
        ...
        self.fc = nn.Linear(512 * Bottleneck.expansion * 7 * 7, feature_dim)
...
class FERModel(nn.Module):
    ...
    def __init__(self, fan_model_path, num_classes=7, feature_dim=512, freeze_fan=True):
        ...
        # IR50 Backbone
        self.backbone = IR50(num_layers=50, feature_dim=feature_dim)
...
def train_fer_model():
    ...
    print("="*60)
    print("PHASE 3: FER MODEL TRAINING")
    print("="*60)
